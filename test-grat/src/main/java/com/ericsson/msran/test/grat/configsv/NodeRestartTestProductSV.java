 ...
 *              Warm restart with traffic 10 times, Code restart with traffic 10 times.
 * @revision eyngjng 2015-11-02
 */

public class NodeRestartTestProductSV extends TestBase {
     ...
     */
    @TestInfo(tcId = "LTE4711", slogan = "Node Restart test case",
            ...
            testDescription = "Runs EFR/FR traffic on all TRX/TS and do warm/cold restart",
            traceGuidelines = "N/A")
    /**
     * Precond.
     */
    ...
    public void teardown() {
        ...
        //Do not do pid check since pid is updated after restart
        //pidPrePost.postCond();
        setTestStepEnd();
    }

    /**
     * @name nodeRestartTestForProduct
     * @description This test class connect Abisco Link and set up multiple Trx, Test warm/cold
     *              restart with maximum load.
     * @param testId
     *        - unique identifier
     * @param description
     * @param numOfTGs
    ...
    @Parameters({ "testId", "description", "numOfTGs", "numOfTrxesPerTG", "isRunManually",
            ...
            "ccchLoadPSPagingRatio", "restartTimes", "restartRank" })
    public void nodeRestartTestForProduct(String testId, String description, final int numOfTGs,
            ...
            @Optional("50") String ccchLoadPSPagingRatio, @Optional("10") int restartTimes, String restartRank) {
        ...
        setTestStepBegin("Print out LTS report Before Restart.");
        printLTSReportBeforeRestart(report);
        setTestStepEnd();

        for (int loop = 1; loop <= restartTimes; loop++) {

            setTestStepBegin("Starting Perfrom restart for " + loop + " times");
            try {
            ...
            if (restartRank.equalsIgnoreCase("warm")) {
                ...
                setTestStepEnd();
            } else if (restartRank.equalsIgnoreCase("cold")) {
                setTestStepBegin("Enable and perform Cold restart");
                momHelper.restartDu();
                ...
                fail("restart Rank must be Warm or Cold");
            }
            ...
            setTestInfo("Restart of RCS for loop : " + loop + " took " + rcsRestartTimeSec + " seconds.");

            long tnRestartTimeSec = calculateTimeDiff(avliDiff, "Tn", "UnOperational", "RestartCompleted");
            setTestInfo("Restart of TN for loop : " + loop + " took " + tnRestartTimeSec + " seconds.");

            long gratRestartTimeSec = calculateTimeDiff(avliDiff, "Grat", "UnOperational",
                    "GRAT Traffic Control active");
            setTestInfo("Restart of GratTrafficCtrl for loop : " + " took " + gratRestartTimeSec + " seconds.");
            setTestInfo("Restart of RBS for loop : " + loop + " took " + gratRestartTimeSec + " seconds.");
            setTestStepEnd();
            ...
            setTestStepBegin("Print out LTS report.");
            printLTSReportAfterRestart(report, loop, numOfTGs);
            setTestStepEnd();
    ...
    private void printLTSReportBeforeRestart(Report report) {
        ...
        if (report != null) {
            ...
            setAdditionalResultInfo("<p><br><b>GRAT Stability load test summary Before Restart:</b>");
            ...
            setAdditionalResultInfo("<p><b>GRAT Stability load test details Before Restart:</b>");
            ...
            // Write summary info report
            setAdditionalResultInfo("<p><b>GRAT Stability load test summary Before Restart:</b>");
    ...
    private void printLTSReportAfterRestart(Report report, int loop, int numOfTGs) {
        ...
        if (report != null) {
            ...
            // Write summary info report
            setAdditionalResultInfo("<p><br><b>GRAT Stability load test summaryafter restart :</b>" + loop
                    + " <p><b>times</b>");
            setAdditionalResultInfo("Test duration: " + timeInSeconds + " s");
            for (int tgId = 0; tgId < numOfTGs; tgId++) {
                setAdditionalResultInfo("tgId = " + tgId + " :Call Setup Rate: "
            ...
            setTestInfo("<p><b>GRAT Stability load test details after restart :</b>" + loop + " <p><b>times</b>");
            ...
            // Write summary info report
            setAdditionalResultInfo("<p><b>GRAT Stability load test summary after restart :</b>" + loop
                    + " <p><b>times</b>");
            setAdditionalResultInfo("Call Success Rate (CSR): Failed test");
            setAdditionalResultInfo("Call Failure Rate (CFR): Failed test");
            setAdditionalResultInfo("SMS Success Rate  (SSR): Failed test");
