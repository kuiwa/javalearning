...
import java.util.HashMap;
	...
	public class AtChannelActivation007 extends TestBase {
	    /**
	    ...
	    public void bsPowerAtChannelActivation007(String testId, String description) throws InterruptedException,
	            JSONException {
	        ...
	        // 02.01.007 BS Power on a BCCH carrier
	        //
	        ...
	        power[1] = TRAFFRN.Enums.BSPower.Pn_8dB; // power level for TS 3
	        power[2] = TRAFFRN.Enums.BSPower.Pn_8dB; // power level for TS 4
	        power[3] = TRAFFRN.Enums.BSPower.Pn_8dB; // power level for TS 5
	        power[4] = TRAFFRN.Enums.BSPower.Pn_8dB; // power level for TS 6
	        power[5] = TRAFFRN.Enums.BSPower.Pn_8dB; // power level for TS 7
	        
	        expectedPowerLevel[0] = 0;
	        expectedPowerLevel[1] = 0;  // should be = powerLevel[0]
	        expectedPowerLevel[2] = 0;  // should be = powerLevel[0]
	        expectedPowerLevel[3] = 0;  // should be = powerLevel[0]
	        expectedPowerLevel[4] = 0;  // should be = powerLevel[0]
	        expectedPowerLevel[5] = 0;  // should be = powerLevel[0]
	        
	        // CC_1
	        // Setup channels on TS 2 - 7.
	        setTestStepBegin("02.01.007 BS Power on a BCCH carrier, CC_1");

	        for (int i = 0; i < 6; i++) // Loop for each time slot
	        {
	        ...
	        // CC_2
	        // Setup channels on TS 2 -7           Half rate not implemented yet.
